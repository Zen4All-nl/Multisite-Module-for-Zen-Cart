...
<!-- bof Multi site -->
          ...
          <tr>
            <td class="main" valign="top"><?php echo EZPAGE_MULTI_FILTER ?></td>
            <td class="main" valign="top"><?php echo zen_draw_input_field('ezpages_description', $ezInfo->ezpages_description, 'size="100"');
